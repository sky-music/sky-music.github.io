...
The program also accepts Sky-JSON recordings generated by the SkyMusic herokupp website (Manage Recordings->Song->Export song) and the SkyStudio app.
...
Finally, the JSON recordings (text files ending with .json) can be fed to the [SkyMusic website](http://sky-music.herokuapp.com), the Android [Sky Music](https://play.google.com/store/apps/details?id=com.herokuapp.sky_music.twa) app and to the Android Sky Studio app.
