...
Finally, the JSON recordings (text files ending with .json.txt) can be fed to the [Sky Music website](http://sky-music.herokuapp.com), the Android [Sky Music](https://play.google.com/store/apps/details?id=com.herokuapp.sky_music.twa) app and to the iOS/Android Sky Studio app.
