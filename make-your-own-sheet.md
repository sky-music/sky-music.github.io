...
## Going further: file formats and SkyStudio compatibility
...
The program also accepts Sky-JSON recordings generated by the <https://sky-music.herokuapp.com> website (Manage Recordings->Song->Export song) and the Sky Studio mobile app.
...
Finally, the JSON recordings (text files ending with .json.txt) can be fed to the [SkyMusic website](http://sky-music.herokuapp.com), the Android [Sky Music](https://play.google.com/store/apps/details?id=com.herokuapp.sky_music.twa) app and to the iOS/Android Sky Studio app.
